...
class BARTModel(TransformerModel):
    ...
    def hub_models(cls):
        return {
            'mbart.base': 'http://dl.fbaipublicfiles.com/fairseq/models/bart.base.tar.gz',
            'mbart.large': 'http://dl.fbaipublicfiles.com/fairseq/models/bart.large.tar.gz',
            'mbart.large.mnli': 'http://dl.fbaipublicfiles.com/fairseq/models/bart.large.mnli.tar.gz',
            'mbart.large.cnn': 'http://dl.fbaipublicfiles.com/fairseq/models/bart.large.cnn.tar.gz',
            'mbart.large.xsum': 'http://dl.fbaipublicfiles.com/fairseq/models/bart.large.xsum.tar.gz',
        }
...
@register_model_architecture('mbart', 'bart_large')
...
@register_model_architecture('mbart', 'bart_base')
...
@register_model_architecture('mbart', 'mbart_large')
def mbart_large_architecture(args):
    args.no_scale_embedding = getattr(args, 'no_scale_embedding', False)
    bart_large_architecture(args)


@register_model_architecture('mbart', 'mbart_base')
def mbart_base_architecture(args):
    args.no_scale_embedding = getattr(args, 'no_scale_embedding', False)
    bart_base_architecture(args)


@register_model_architecture('mbart', 'mbart_base_wmt20')
