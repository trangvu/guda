...
def make_positions(tensor, padding_idx: int, onnx_trace: bool = False, offset_positions_by_padding=1):
    ...
    return (torch.cumsum(mask, dim=1).type_as(mask) * mask).long() + padding_idx * offset_positions_by_padding
