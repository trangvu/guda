...
#for L in $SRC_LANG $TGT_LANG; do
  DATA_DIR=$ALNMT_DIR/nmt/acl2021/preprocess/data-bin/uda/train/$lang_pair/${domain}/${seltype}/$L/en-$L
  SAVE_DIR=$ALNMT_DIR/models/uda/${lang_pair}/tgt_avai-$domain-${seltype}-$L
  echo '**************************************'
