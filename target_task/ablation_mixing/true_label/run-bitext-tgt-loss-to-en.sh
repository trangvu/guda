...
DATA_DIR=$ALNMT_DIR/nmt/acl2021/preprocess/data-bin/ablation-uda/$DATASET/$exp_name
SAVE_DIR=$ALNMT_DIR/models/ablation-uda/$DATASET/bi_tgt-to-en-$exp_name-$DATE
echo '**************************************'
...
fairseq-train $DATA_DIR \
  ...
  --tensorboard-logdir $SAVE_DIR/log --disable-src-loss --num-workers 0
