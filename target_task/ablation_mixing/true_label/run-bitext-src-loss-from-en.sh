...
SAVE_DIR=$ALNMT_DIR/models/ablation-uda/$DATASET/bi_src-from-en-$exp_name-$DATE
echo '**************************************'
...
fairseq-train $DATA_DIR \
  ...
  --label-subset label --num-workers 0 \
  --max-tokens 4096 --update-freq 22 \
  --tensorboard-logdir $SAVE_DIR/log --disable-tgt-loss
