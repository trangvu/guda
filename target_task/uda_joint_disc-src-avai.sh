...
L=$SRC_LANG
  DATA_DIR=$ALNMT_DIR/nmt/acl2021/preprocess/data-bin/uda/train/$lang_pair/${domain}/${seltype}/$L/$SRC_LANG-en
  SAVE_DIR=$ALNMT_DIR/models/uda/${lang_pair}/src_avai-$domain-${seltype}-$L
  echo '**************************************'
